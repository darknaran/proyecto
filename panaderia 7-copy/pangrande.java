...
public class pangrande extends Pan{
   private double ventauno;
    ...
    pangrande(String identificacion, String nombre,  double ventauno, double ventados, double ventatres,double ventacuatro,double ventacinco,double ventaseis,double ventasiete)throws Exception{
