public class pannormal extends Pan{
    ...
    pannormal(String identificacion, String nombre,  double ventauno, double ventados, double ventatres,double ventacuatro,double ventacinco,double ventaseis,double ventasiete)throws Exception{
